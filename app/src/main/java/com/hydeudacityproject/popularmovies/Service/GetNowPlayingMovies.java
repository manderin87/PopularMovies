...
public class GetNowPlayingMovies extends AsyncTask<Void, Void, GetMoviesResponse> {
    ...
    public GetNowPlayingMovies(Context context, GetMoviesListener listener, int page) {
