...
public class GetUpcomingMovies extends AsyncTask<Void, Void, GetMoviesResponse> {
    ...
    public GetUpcomingMovies(Context context, GetMoviesListener listener, int page) {
