...
import com.hydeudacityproject.popularmovies.Service.GetPopularMovies.GetMoviesListener;
...
public class GetHighestRatedMovies extends AsyncTask<Void, Void, GetMoviesResponse> {
    ...
    public GetHighestRatedMovies(Context context, GetMoviesListener listener, int page) {
